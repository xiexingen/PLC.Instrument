    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ExceptionMessage = c.String(maxLength: 1024),
                ...
                c => new
                    {
                        ...
                        TenantId = c.Int(),
                        NewValueHash = c.String(),
                        OriginalValueHash = c.String(),
                    },
                annotations: new Dictionary<string, object>
                {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.AbpUsers", t => t.UserId, cascadeDelete: true)
                .Index(t => t.TenantId)
                .Index(t => new { t.ProviderKey, t.TenantId }, unique: true)
                .Index(t => t.UserId);
